...
class AITutor:
    def __init__(self):
        ...
        try:
            ...
            # Use GPT-2 (or distilGPT-2 for a smaller model)
            self.model_name = "distilgpt2"  # Replace with "gpt2" if desired
            ...
            # Use CPU for the model
            self.device = torch.device('cpu')
            self.model = self.model.to(self.device)

            print("GPT model initialized successfully on CPU")
        except Exception as e:
            print(f"Error initializing GPT model: {str(e)}")
            self.model = None
            self.tokenizer = None
    ...
    def generate_response(self, question, learning_style):
        ...
        if not self.model or not self.tokenizer:
            return "I apologize, but the GPT model is not properly initialized."
        ...
        try:
            ...
            if learning_style == "real_life":
                ...
                prompt = (
                    ...
                    "multiple easy-to-understand examples."
                )
...
if __name__ == "__main__":
    ...
    style = "simplified"
    response = tutor.generate_response(question, style)
    print(response)
